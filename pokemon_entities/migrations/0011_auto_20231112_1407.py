# Generated by Django 3.1.14 on 2023-11-12 14:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pokemon_entities', '0010_auto_20231112_1051'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='appeared_at',
            field=models.DateTimeField(default=None, verbose_name='Появится/появится'),
        ),
        migrations.AlterField(
            model_name='pokemonentity',
            name='defence',
        ...
        migrations.AlterField(
            model_name='pokemonentity',
            name='disappeared_at',
            field=models.DateTimeField(default=None, verbose_name='Исчезнет/исчез'),
        ),
        migrations.AlterField(
            model_name='pokemonentity',
            name='health',
        ...
        migrations.AlterField(
            model_name='pokemonentity',
            name='pokemon',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pokemon_entities', to='pokemon_entities.pokemon', verbose_name='Вид покемона'),
        ),
        migrations.AlterField(
            model_name='pokemonentity',
            name='stamina',
